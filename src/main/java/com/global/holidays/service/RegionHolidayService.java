...
public class RegionHolidayService {
    ...
    public List<RegionHolidayDto> getRegionHolidaysByCountryNameAndYear(String countryName, int year) {
        ...
        return regionHolidays.stream()
                .map(rh -> new RegionHolidayDto(
                        rh.getRegion().getCountry().getCountryName(),
                        rh.getRegion().getRegionName(),
                        rh.getHoliday().getHolidayName(),
                        rh.getHoliday().getHolidayType().getTypeName(),
                        rh.getStartDate(),
                        rh.getDurationDays()
                ))
